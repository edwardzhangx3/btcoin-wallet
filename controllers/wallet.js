...
var client = require("../models/walletClient").getClient()
var path = require('path');
var fs = require('fs');
var config = require("../configure")
var { success, fail } = require("../module")
let myUtils = require("../module")

module.exports = {
    walletCreate: (req, res) => {
        let { walletname, password } = req.body
        console.log(req.body)
/*code from bitpay/bwc*/
    ...
    walletImportWithMnemonic: (req, res) => {
        ...
        client.createWallet(walletname, config.copayerName, 1, 1, {
            ...
            client.createAddress({}, function (err, addr) {
                ...
                res.send(success("success import"))
            });
        })
    },
